...
import { insumosRouter, fichasTecnicasRouter, perdasRouter, diarioProducaoRouter, contagensRouter, dashboardRouter, contagensDiariasRouter, auditoriaRouter, deveresRouter } from "./cozinha";
