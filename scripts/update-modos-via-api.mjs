// Script para atualizar modos de preparo via API TRPC
const modosPreparo = [
  {
    produto: "(PR) Picles de Cebola Roxa",
    modoPreparo: `1. Fatie as cebolas roxas em rodelas finas.
...
Validade: 2-3 semanas refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Lave e fatie os pepinos japoneses em rodelas de espessura média.
...
Validade: 3-4 semanas refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Asse a cabeça de alho: corte o topo, regue com azeite, envolva em alumínio e asse a 180°C por 30-40min.
...
Validade: 3-4 dias refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Lave bem e seque o coentro (1/2 maço).
...
Validade: 2-3 dias refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Em um recipiente, misture a maionese base (500g) com páprica defumada (10g) e pimenta calabresa em flocos (2-4g).
...
Validade: 4-5 dias refrigerado. AVISO: Picante!`
  },
  {
    ...
    modoPreparo: `1. Prepare a mostarda base: misture mostarda amarela (250g), vinagre de maçã (30ml), açúcar mascavo (15g), páprica doce e cúrcuma.
...
Validade: 1-2 semanas refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Lave os grãos de mostarda (200g) e deixe de molho em água com sal por 24-48h.
...
Validade: 6 meses refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Aqueça azeite (50ml) em panela grande em fogo médio.
...
Validade: 5-7 dias refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Em panela média, reduza a cachaça (200ml) pela metade em fogo médio.
...
Validade: 7-10 dias refrigerado. AVISO: Pode conter traços de álcool.`
  },
  {
    ...
    modoPreparo: `1. Faça um X na base dos tomates italianos (1kg), mergulhe em água fervente por 30-60s e transfira para água gelada. Remova a pele.
...
Validade: 5-7 dias refrigerado. Pode ser congelado.`
  },
  {
    ...
    modoPreparo: `1. Selecione tomates italianos maduros e firmes. Lave bem.
...
Validade: 2-3 semanas refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Fatie o bacon em tiras de espessura média.
...
Tempo de preparo: 8-10 minutos.`
  },
  {
    ...
    modoPreparo: `1. Corte o bacon em cubos pequenos (500g) e cozinhe em frigideira em fogo médio-baixo até dourar e ficar crocante.
...
Validade: 3-5 dias em temperatura ambiente ou 7-10 dias refrigerado. CONTÉM CASTANHA DO PARÁ.`
  ...
  {
    produto: "(PR) Banha - aproveitamento bacon",
    modoPreparo: `1. Colete a gordura liberada durante o preparo do bacon crocante.
...
Validade: 2-3 semanas refrigerado.`
  },
  {
    ...
    modoPreparo: `1. Utilize a proporção definida de cortes (ex: 60% acém, 40% peito bovino).
...
Para grelhar: Chapa quente, 2-3min de cada lado para ponto médio.`
  },
  {
    ...
    modoPreparo: `1. Tempere a sobrecoxa desossada (150g) com sal, pimenta e temperos desejados.
...
Tempo de preparo: 8-10 minutos.`
  },
  {
    ...
    modoPreparo: `1. Prepare a marinada: misture mostarda (100g), alho picado (4 dentes), azeite (30ml), sal e pimenta.
...
Validade da marinada: usar no mesmo dia.`
  },
  {
    ...
    modoPreparo: `1. Misture farinha de trigo (500g) com flocão de milho (200g).
...
// Chamar a API para cada item
async function updateModosPreparo() {
  console.log('Atualizando modos de preparo via API...\n');
  
  for (const item of modosPreparo) {
    try {
      const response = await fetch('http://localhost:3000/api/trpc/fichasTecnicas.updateModoPreparo', {
        method: 'POST',
        headers: {
      ...
      if (result.result?.data?.success) {
        ...
        console.log(`✗ ${item.produto}: ${JSON.stringify(result)}`);
      }
    } catch (error) {
