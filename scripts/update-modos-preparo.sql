-- Atualizar modos de preparo das fichas técnicas de Preparo

-- Picles de Cebola Roxa
UPDATE fichas_tecnicas SET modoPreparo = '1. Fatie as cebolas roxas em rodelas finas.
...
Validade: 2-3 semanas refrigerado.' WHERE produto = '(PR) Picles de Cebola Roxa';

-- Picles de Pepino
UPDATE fichas_tecnicas SET modoPreparo = '1. Lave e fatie os pepinos japoneses em rodelas de espessura média.
...
Validade: 3-4 semanas refrigerado.' WHERE produto = '(PR) Picles de Pepino';

-- Maionese de Alho e Orégano
UPDATE fichas_tecnicas SET modoPreparo = '1. Asse a cabeça de alho: corte o topo, regue com azeite, envolva em alumínio e asse a 180°C por 30-40min.
2. Esprema os dentes de alho assados.
3. No processador, bata a maionese base (500g) com o alho assado até homogêneo.
4. Adicione orégano seco (5g) e gotas de fumaça líquida se desejar.
5. Tempere com sal e pimenta-do-reino a gosto.
6. Transfira para recipiente com tampa e refrigere.
Validade: 3-4 dias refrigerado.' WHERE produto = '(PR) Maionese de Alho e Orégano';

-- Maionese Verde
UPDATE fichas_tecnicas SET modoPreparo = '1. Lave bem e seque o coentro (1/2 maço).
...
Validade: 2-3 dias refrigerado.' WHERE produto = '(PR) Maionese Verde - Coentro e Limão';

-- Maionese Vermelha
UPDATE fichas_tecnicas SET modoPreparo = '1. Em um recipiente, misture a maionese base (500g) com páprica defumada (10g) e pimenta calabresa em flocos (2-4g).
...
Validade: 4-5 dias refrigerado. AVISO: Picante!' WHERE produto = '(PR) Maionese Vermelha - Páprica e Calabresa';

-- Mostarda da Casa com Mel
UPDATE fichas_tecnicas SET modoPreparo = '1. Prepare a mostarda base: misture mostarda amarela (250g), vinagre de maçã (30ml), açúcar mascavo (15g), páprica doce e cúrcuma.
...
Validade: 1-2 semanas refrigerado.' WHERE produto = '(PR) Mostarda da Casa com Mel';

-- Mostarda hidratada
UPDATE fichas_tecnicas SET modoPreparo = '1. Lave os grãos de mostarda (200g) e deixe de molho em água com sal por 24-48h.
...
Validade: 6 meses refrigerado.' WHERE produto = '(PR) Mostarda hidratada';

-- Cebola Caramelizada com Rapadura
UPDATE fichas_tecnicas SET modoPreparo = '1. Aqueça azeite (50ml) em panela grande em fogo médio.
...
Validade: 5-7 dias refrigerado.' WHERE produto = '(PR) Cebola Caramelizada com Rapadura';

-- Chutney de Cupuaçu
UPDATE fichas_tecnicas SET modoPreparo = '1. Em panela média, reduza a cachaça (200ml) pela metade em fogo médio.
...
Validade: 7-10 dias refrigerado. AVISO: Pode conter traços de álcool.' WHERE produto = '(PR) Chutney de Cupuaçu Cachaça e Cebola';

-- Tomate Tomatudo
UPDATE fichas_tecnicas SET modoPreparo = '1. Faça um X na base dos tomates italianos (1kg), mergulhe em água fervente por 30-60s e transfira para água gelada. Remova a pele.
...
7. Deixe esfriar e armazene refrigerado.
Validade: 5-7 dias refrigerado. Pode ser congelado.' WHERE produto = '(PR) Tomate Tomatudo';

-- Tomates fermentados
UPDATE fichas_tecnicas SET modoPreparo = '1. Selecione tomates italianos maduros e firmes. Lave bem.
...
Validade: 2-3 semanas refrigerado.' WHERE produto = '(PR) Tomates fermentados';

-- Bacon crocante
UPDATE fichas_tecnicas SET modoPreparo = '1. Fatie o bacon em tiras de espessura média.
...
Tempo de preparo: 8-10 minutos.' WHERE produto = '(PR) Bacon crocante';

-- Bacon em Cubos Com Castanha do Pará
UPDATE fichas_tecnicas SET modoPreparo = '1. Corte o bacon em cubos pequenos (500g) e cozinhe em frigideira em fogo médio-baixo até dourar e ficar crocante.
...
Validade: 3-5 dias em temperatura ambiente ou 7-10 dias refrigerado. CONTÉM CASTANHA DO PARÁ.' WHERE produto = '(PR) Bacon em Cubos Com Castanha do Pará';

-- Banha - aproveitamento bacon
UPDATE fichas_tecnicas SET modoPreparo = '1. Colete a gordura liberada durante o preparo do bacon crocante.
...
Validade: 2-3 semanas refrigerado.' WHERE produto = '(PR) Banha - aproveitamento bacon';

-- Blend 150g
UPDATE fichas_tecnicas SET modoPreparo = '1. Utilize a proporção definida de cortes (ex: 60% acém, 40% peito bovino).
...
Para grelhar: Chapa quente, 3-4min de cada lado para ponto médio.' WHERE produto = '(PR) Blend 150g';
...
5. Embale individualmente em papel manteiga ou filme.
6. Armazene refrigerado (uso em 24h) ou congele.
Para grelhar: Chapa quente, 2-3min de cada lado para ponto médio.' WHERE produto = '(PR) Blend 120g';

-- Coxa/Sobrecoxa de Frango Empanadas
UPDATE fichas_tecnicas SET modoPreparo = '1. Tempere a sobrecoxa desossada (150g) com sal, pimenta e temperos desejados.
...
Tempo de preparo: 8-10 minutos.' WHERE produto = '(PR) Coxa/Sobrecoxa de Frango Empanadas';

-- Coxa/Sobrecoxa Frango Mar. Mostarda/Alho
UPDATE fichas_tecnicas SET modoPreparo = '1. Prepare a marinada: misture mostarda (100g), alho picado (4 dentes), azeite (30ml), sal e pimenta.
...
Validade da marinada: usar no mesmo dia.' WHERE produto = '(PR) Coxa/Sobrecoxa Frango Mar. Mostarda/Alho';

-- Farinhas Trigo e Flocão Para Empanação
UPDATE fichas_tecnicas SET modoPreparo = '1. Misture farinha de trigo (500g) com flocão de milho (200g).
...
Validade: 30 dias em local seco.' WHERE produto = '(PR) Farinhas Trigo e Flocão Para Empanação';
